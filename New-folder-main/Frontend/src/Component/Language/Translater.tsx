  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 left-6 z-50 language-selector-container">
                ...
                {languages.map((lang) => (
                  <motion.button
                    ...
                    className={`block w-full text-left px-4 py-3 rounded-xl transition-colors flex items-center space-x-3 ${
                      currentLanguage === lang.code ? "from-green-100 via-green-50 to-white transition-all" : "hover:bg-green-50"
                    }`}
        ...
        >
          <motion.div 
            className="relative z-10 bg-gradient-to-r from-green-200 via-green-50 to-green-200 transition-all text-black rounded-full shadow-lg flex flex-col items-center justify-center focus:outline-none"
            animate={{ 
              boxShadow: isOpen 
