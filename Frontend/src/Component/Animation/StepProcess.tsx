...
export default function StepProcess() {
  ...
  return (
    <section className="relative w-full py-16 bg-gradient-to-b from-green-50 via-yellow-50 to-green-100 flex flex-col items-center justify-center overflow-hidden z-0">
      {/* Heading */}
      <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-10">
        Explore Ayurvedic{" "}
        <span className="text-green-700 border-b-4 border-green-600 pb-1">
          Remedies
        </span>
      </h2>
          ...
          return (
            ...
            >
              <div
                ...
                className="bg-white rounded-2xl shadow-lg hover:shadow-2xl cursor-pointer w-[460px] md:w-[500px] h-[300px] md:h-[320px] overflow-hidden flex flex-col border border-green-100 transition-all"
              >
                {/* Image Section */}
                ...
                <div className="flex flex-col justify-between items-center p-4 text-center flex-1">
                  ...
                  <button className="bg-green-600 hover:bg-green-700 text-white text-xs md:text-sm font-medium rounded-full px-5 py-2 transition-all">
                    Learn More
                  </button>
                </div>
              </div>
          ...
          <button
            ...
            className={`rounded-full transition-all ${
              idx === current
                ...
                : "bg-green-300 w-2 h-2 hover:bg-green-400"
            }`}
          />
        ))}
      </div>
