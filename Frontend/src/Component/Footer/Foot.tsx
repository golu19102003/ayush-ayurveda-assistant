...
export default function Foot() {
  return (
    <footer className="w-full bg-gradient-to-b from-green-50 via-green-50 to-white text-green-900 px-8 md:px-16 lg:px-24 py-20 font-[Inter] border-t border-green-200 shadow-inner relative z-10">
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left relative">
        ...
        <div className="relative md:pr-8">
          <Link
            to="/"
            className="flex items-center justify-center md:justify-start text-4xl font-extrabold tracking-tight text-green-800 mb-6 hover:scale-105 transition-transform"
          >
            <img
              src={logo}
          ...
          <p className="text-green-800 text-base leading-relaxed">
            Ayush is your all-in-one Ayurvedic medical platform, merging ancient healing with AI innovation. 
            Discover trusted doctors, natural remedies, and personalized health insights — all in one place.
          </p>

          {/* Vertical Divider */}
          <div className="hidden md:block absolute right-0 top-0 h-full border-r border-green-200"></div>
        </div>

        {/* QUICK LINKS */}
        <div className="relative md:px-8">
          <h3 className="text-2xl font-bold text-green-800 mb-6 border-b-2 border-green-500 inline-block pb-1">
            🔗 Quick Links
          </h3>
          <ul className="space-y-4 text-base text-green-600">
            <li>
              <NavLink
                to="/fitness"
        ...
        <div className="md:pl-8">
          ...
          {/* Social Media Links */}
          <div className="flex justify-center md:justify-start space-x-6 mt-8 text-green-700">
            <a
            ...
            <a
              href="https://github.com/relatablepradeep/Ayush"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-green-600 transition-transform transform hover:scale-110"
            >
      ...
      {/* Divider */}
      <div className="w-full border-t border-green-300 my-12"></div>
